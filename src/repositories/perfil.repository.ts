...
export class PerfilRepository extends DefaultCrudRepository<
  ...
  PerfilRelations
> {
  public readonly marketPlaces: HasManyRepositoryFactory<
    MarketPlace,
    typeof Perfil.prototype.perfilId
  >;

  public readonly publicaciones: HasManyRepositoryFactory<
    Publicacion,
    typeof Perfil.prototype.perfilId
  >;

  public readonly historias: HasManyRepositoryFactory<
    Historia,
    typeof Perfil.prototype.perfilId
  >;
  ...
  constructor(
    ...
    @repository.getter('MarketPlaceRepository')
    protected marketPlaceRepositoryGetter: Getter<MarketPlaceRepository>,
    ...
    this.historias = this.createHasManyRepositoryFactoryFor(
      'historias',
      historiaRepositoryGetter,
    );
    this.registerInclusionResolver(
      'historias',
      this.historias.inclusionResolver,
    );
    this.publicaciones = this.createHasManyRepositoryFactoryFor(
      'publicaciones',
      publicacionRepositoryGetter,
    );
    this.registerInclusionResolver(
      'publicaciones',
      this.publicaciones.inclusionResolver,
    );
    this.marketPlaces = this.createHasManyRepositoryFactoryFor(
      'marketPlaces',
      marketPlaceRepositoryGetter,
    );
    this.registerInclusionResolver(
      'marketPlaces',
      this.marketPlaces.inclusionResolver,
    );
  }
}
