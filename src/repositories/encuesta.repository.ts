...
> {
  ...
  public readonly respuestaEncuestas: HasManyRepositoryFactory<
    RespuestaEncuesta,
    typeof Encuesta.prototype.encuestaId
  >;
  ...
  constructor(
    ...
    @repository.getter('RespuestaEncuestaRepository')
    protected respuestaEncuestaRepositoryGetter: Getter<RespuestaEncuestaRepository>,
  ) {
    super(Encuesta, dataSource);
    this.respuestaEncuestas = this.createHasManyRepositoryFactoryFor(
      'respuestaEncuestas',
      respuestaEncuestaRepositoryGetter,
    );
    this.registerInclusionResolver(
      'respuestaEncuestas',
      this.respuestaEncuestas.inclusionResolver,
    );
