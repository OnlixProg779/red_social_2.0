...
export class ChatRepository extends DefaultCrudRepository<
  ...
  ChatRelations
> {
  public readonly reaccionChats: HasManyRepositoryFactory<
    ReaccionChat,
    typeof Chat.prototype.chatId
  >;
  ...
  constructor(
    ...
    @repository.getter('ReaccionChatRepository')
    ...
    this.reaccionChats = this.createHasManyRepositoryFactoryFor(
      'reaccionChats',
      reaccionChatRepositoryGetter,
    );
    this.registerInclusionResolver(
      'reaccionChats',
      this.reaccionChats.inclusionResolver,
    );
  }
}
