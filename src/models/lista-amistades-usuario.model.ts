...
export class ListaAmistadesUsuario extends Entity {
  @property({
    ...
    id: 1,
    postgresql: {
      columnName: 'ListaAmistadesUsuarioId',
      dataType: 'uuid',
      dataLength: null,
      dataPrecision: null,
      dataScale: null,
  ...
  listaAmistadesUsuarioId: string = uuidv4();
...
export type ListaAmistadesUsuarioWithRelations = ListaAmistadesUsuario &
